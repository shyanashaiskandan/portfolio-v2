  ...
  return (
    <section id="experience" className={styles.container}>
      ...
      <VerticalTimeline animate={true} lineColor="black">
        ...
        >
          <center>
            <img src={empireLife} alt="gov logo" className={styles.empireLife} />
          </center>
          <center>
            <h3 style={{ color: "#ffffff" }}>Software Developer</h3>
          </center>
          <center>
            <h4 style={{ color: "#f9f1f1" }}>Empire Life</h4>
          </center>
        </VerticalTimelineElement>
        ...
        >
          <center>
            <img src={gov} alt="gov logo" className={styles.govlogo} />
          </center>
          <center>
            <h3 style={{ color: "#ffffff" }}>Junior Programmer</h3>
          </center>
          <center>
            <h4 style={{ color: "#f9f1f1" }}>Ministry of Finance</h4>
          </center>
        </VerticalTimelineElement>
        ...
        >
          <center>
            <img src={bmo} alt="BMO logo" className={styles.bmo} />
          </center>
          <center>
            <h3 style={{ color: "#ffffff" }}>Systems and Applications Analyst</h3>
          </center>
          <center>
            <h4 style={{ color: "#f9f1f1" }}>Bank of Montreal</h4>
          </center>
        </VerticalTimelineElement>
        ...
        >
          ...
          <center>
            <h3 style={{ color: "#ffffff" }}>QA Analyst</h3>
          </center>
          <center>
            <h4 style={{ color: "#f9f1f1" }}>Bank of Montreal</h4>
          </center>
