...
import profileImage from "/assets/about/shyana2.jpg"
      ...
      <section id="about" className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            I'm a Computer Engineering graduate from the 
          ...
          <p className={styles.description}>
            With experience in testing, development, and deployment, I’m focused on growing as a
            <span className={styles.highlightBlue}> software engineer</span> while continuing to expand my technical skills and build impactful, user-focused solutions.
          </p>
